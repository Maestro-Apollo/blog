...
<body id="top">
    ...
    <section class="s-content s-content--no-top-padding"">
        ...
        <div style="float: left">
            <p style="margin-left: 50px"> Showing results for <span
                    style="font-style: italic; font-weight: 700"><?php echo $_SESSION['username']; ?></span><br><a
                    href="post.php">Create a post</a><a href="logout.php">Logout</a></p>
        </div>
